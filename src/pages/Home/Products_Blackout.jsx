  ...
  const services = [
    {
      id: 1,
      name: "Carpets",
      image: "/images/services/carpets.jpg",
    ...
    },
    {
      ...
      link: "/services/sofa-mojlish",
    },
    {
      id: 3,
      name: "PVC Barkia",
      image: "/images/services/pvc.jpg",
      link: "/services/pvc-barkia",
    },
    {
      id: 4,
      name: "Moving & Shifting",
      image: "/images/services/moving.jpg",
      link: "/services/moving-shifting",
    },
    {
      id: 5,
      name: "Wallpapers",
      image: "/images/services/wallpapers.jpg",
    ...
    <section className="bg-[#F9F5F1] py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-gray-600 mt-3 max-w-lg mx-auto text-sm md:text-base">
          Explore our most sought-after home improvement services, crafted to
