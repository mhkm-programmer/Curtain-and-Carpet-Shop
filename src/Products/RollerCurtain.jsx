...
const mediaGallery = [
  { type: "image", src: "https://8upload.com/image/roller1.jpg" },
  { type: "video", src: "https://streamable.com/e/rollerVid1" },
  { type: "image", src: "https://8upload.com/image/roller2.jpg" },
  { type: "video", src: "https://streamable.com/e/rollerVid2" },
  { type: "image", src: "https://8upload.com/image/roller3.jpg" },
  { type: "image", src: "https://8upload.com/image/roller4.jpg" },
];
  ...
  return (
    <div className="font-sans text-[#1F1F1F] bg-white">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        <h1 className="text-4xl font-bold mb-4">Roller Curtains Tailored for Your Space</h1>
      ...
      <section className="bg-[#F9F9F9] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-semibold mb-10">Why Choose Our Roller Curtains?</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <h2 className="text-3xl font-semibold text-center mb-10">Gallery: Roller Curtain Projects</h2>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              {
                name: "Nora F.",
                comment: "Roller curtains installed by the team look fantastic and operate smoothly!",
              },
              {
                name: "Faisal R.",
                comment: "Great fabric options and very professional installation service.",
              },
            ].map((testi, idx) => (
      ...
      <section className="bg-[#B8860B] py-20 text-white text-center px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold mb-4">Get Your Perfect Roller Curtains Today</h2>
